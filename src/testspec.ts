...
import {determineOpenAPIVersion} from "./@helpers/determineOpenAPIVersion";
...
async function initializeClient() {
    try {
        ...
        if (spec) {
            ...
            // Use determineOpenAPIVersion to get the OpenAPI version
            const openAPIVersion = determineOpenAPIVersion(filePath);
